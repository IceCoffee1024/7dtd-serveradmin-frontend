...
6. Reload the settings from the backend, then sign out and sign in again if the session or backend address changed. Update the reverse proxy and frontend environment together when changing the address.
